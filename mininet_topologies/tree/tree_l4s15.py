...
def myNetwork():
    ...
    s8h2 = {'bw':100,'delay':'2ms'}
    net.addLink(s8, h2, cls=TCLink , **s8h2)
    s9h3 = {'bw':100,'delay':'2ms'}
    net.addLink(s9, h3, cls=TCLink , **s9h3)
    s10h5 = {'bw':100,'delay':'2ms'}
    net.addLink(s10, h5, cls=TCLink , **s10h5)
    s10h6 = {'bw':100,'delay':'2ms'}
    net.addLink(s10, h6, cls=TCLink , **s10h6)
    s11h7 = {'bw':100,'delay':'2ms'}
    net.addLink(s11, h7, cls=TCLink , **s11h7)
    s11h8 = {'bw':100,'delay':'2ms'}
    net.addLink(s11, h8, cls=TCLink , **s11h8)
    s9h4 = {'bw':100,'delay':'2ms'}
    net.addLink(s9, h4, cls=TCLink , **s9h4)
    s12h10 = {'bw':100,'delay':'2ms'}
    net.addLink(s12, h10, cls=TCLink , **s12h10)
    s12h11 = {'bw':100,'delay':'2ms'}
    net.addLink(s12, h11, cls=TCLink , **s12h11)
    s13h12 = {'bw':100,'delay':'2ms'}
    net.addLink(s13, h12, cls=TCLink , **s13h12)
    s13h13 = {'bw':100,'delay':'2ms'}
    net.addLink(s13, h13, cls=TCLink , **s13h13)
    s14h14 = {'bw':100,'delay':'2ms'}
    net.addLink(s14, h14, cls=TCLink , **s14h14)
    s14h15 = {'bw':100,'delay':'2ms'}
    net.addLink(s14, h15, cls=TCLink , **s14h15)
    s15h16 = {'bw':100,'delay':'2ms'}
    net.addLink(s15, h16, cls=TCLink , **s15h16)
    s15h17 = {'bw':100,'delay':'2ms'}
    net.addLink(s15, h17, cls=TCLink , **s15h17)
